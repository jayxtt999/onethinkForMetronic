						...
						<div class="row">
							<div class="col-md-6 cf">
								<div class="fl">
									...
									<button  url="<?php echo U('createGroup');?>" id="add-group" class="btn green" >新 增</button>
									<button  url="<?php echo U('changestatus',array('method'=>'resumeGroup'));?>" class="btn green ajax-post" target-form="ids" >启 用</button>
									<button  url="<?php echo U('changestatus',array('method'=>'forbidGroup'));?>" class="btn green ajax-post" target-form="ids" >禁 用</button>
									<button  url="<?php echo U('changestatus',array('method'=>'deleteGroup'));?>" class="btn green ajax-post confirm" target-form="ids" >删 除</button>
