        ...
        <div class="col-md-12">
            ...
            <div class="portlet box grey-cascade">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-globe"></i><?php if(isset($data)): ?>[ <?php echo ($data["title"]); ?> ] 子<?php endif; ?>菜单管理
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6 cf">
                                <div class="fl">
                                    <button class="btn green" url="<?php echo U('add',array('pid'=>I('get.pid',0)));?>" id="add-menu">新 增</button>
                                    <button class="btn green ajax-post confirm" url="<?php echo U('del');?>" target-form="ids">删 除</button>
                                    <button class="btn green" url="<?php echo U('import',array('pid'=>I('get.pid',0)));?>" id="import">导 入</button>
                                    <button class="btn green list_sort" url="<?php echo U('sort',array('pid'=>I('get.pid',0)),'');?>">排序</button>               </div>
                            </div>
                        </div>
                    </div>
                    <table class="table table-striped table-bordered table-hover" id="dataTables-menu"><!-- 必须设定表格的id == -->
                        ...
                        <tbody>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                <td><input class="checkboxes ids row-selected" type="checkbox" name="id[]" value="<?php echo ($menu["id"]); ?>"></td>
