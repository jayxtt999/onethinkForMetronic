        ...
        <div class="col-lg-12">
            ...
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-globe"></i><?php echo ($auth_group['id']?'编辑':'新增'); ?>用户组
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <div role="form">
                        <form action="<?php echo U('AuthManager/writeGroup');?>" enctype="application/x-www-form-urlencoded"
                              method="POST" class="form-body" role="form">
                            <div class="form-group">
                                <label for="auth-title" class="item-label">用户组</label>
                                <div class="input-group"><input id="auth-title" type="text" name="title" class="form-control"
                                       value="<?php echo ($auth_group["title"]); ?>"/></div>
                            </div>
                            <div class="form-group">
                                <label for="auth-description" class="item-label">描述</label>
                                <div class="input-group"><textarea id="auth-description" type="text" name="description" class="form-control"><?php echo ($auth_group["description"]); ?></textarea>
                            </div>
                                </div>
                            <div class="form-group">
                                <input type="hidden" name="id" value="<?php echo ($auth_group["id"]); ?>"/>
                                <button type="submit" class="btn green submit-btn ajax-post" target-form="form">确 定
                                </button>
